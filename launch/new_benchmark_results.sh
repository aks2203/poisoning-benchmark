...
bash benchmark_tiny.sh poison_examples/tinyimagenet_transfer/clbd_poisons/num_poisons=250/
...
bash benchmark_tiny.sh poison_examples/tinyimagenet_transfer/htbd_poisons/num_poisons=250/
#
